 ...
 * LOCAL FUNCTIONS
 */
static void flybirdBLECentralProcessGATTMsg( gattMsgEvent_t *pMsg );
static void flybirdBLECentralRssiCB( uint16 connHandle, int8  rssi );
static uint8 flybirdBLECentralEventCB( gapCentralRoleEvent_t *pEvent );
static void flybirdBLECentralPasscodeCB( uint8 *deviceAddr, uint16 connectionHandle,
                                        uint8 uiInputs, uint8 uiOutputs );
static void flybirdBLECentralPairStateCB( uint16 connHandle, uint8 state, uint8 status );
static void NpiSerialCentralCB( uint8 port, uint8 events );
static void flybirdBLECentral_HandleKeys( uint8 shift, uint8 keys );
static void flybirdBLECentral_ProcessOSALMsg( osal_event_hdr_t *pMsg );
static void simpleBLEGATTDiscoveryEvent( gattMsgEvent_t *pMsg );
static void flybirdBLECentralStartDiscovery( void );
...
{
  flybirdBLECentralRssiCB,       // RSSI callback
  flybirdBLECentralEventCB       // Event callback
};

// Bond Manager Callbacks
static const gapBondCBs_t simpleBLEBondCB =
{
  flybirdBLECentralPasscodeCB,
  flybirdBLECentralPairStateCB
};
 ...
 * @return  none
 */
void FlybirdBLECentral_Init( uint8 task_id )
{
...
/*********************************************************************
 * @fn      FlybirdBLECentral_ProcessEvent
 *
 ...
 */
uint16 FlybirdBLECentral_ProcessEvent( uint8 task_id, uint16 events )
{
  ...
  if ( events & SYS_EVENT_MSG )
  {
    ...
    {
      flybirdBLECentral_ProcessOSALMsg( (osal_event_hdr_t *)pMsg );
  ...
  {
    flybirdBLECentralStartDiscovery( );
...
/*********************************************************************
 * @fn      flybirdBLECentral_ProcessOSALMsg
 *
...
static void flybirdBLECentral_ProcessOSALMsg( osal_event_hdr_t *pMsg )
{
  ...
  {
    case KEY_CHANGE:
      flybirdBLECentral_HandleKeys( ((keyChange_t *)pMsg)->state, ((keyChange_t *)pMsg)->keys );
      break;

    case GATT_MSG_EVENT:
      flybirdBLECentralProcessGATTMsg( (gattMsgEvent_t *) pMsg );
      break;
  }
}

/*********************************************************************
 * @fn      flybirdBLECentral_HandleKeys
 *
...
/*********************************************************************
 * @fn      flybirdBLECentralProcessGATTMsg
 *
...
/*********************************************************************
 * @fn      flybirdBLECentralPasscodeCB
 *
...
/*********************************************************************
 * @fn      flybirdBLECentralStartDiscovery
 *
